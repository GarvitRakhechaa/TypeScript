...
function combine1(num1:number|string, num2:number|string, type1:"as-number"|"as-string") {
    let result
...
//type alias
type combineable = number | string | boolean | null

function Hello(num1: combineable, num2: combineable){
    let result
    if(typeof num1 === "number" && typeof num2 === "number" ){
        result =  num1 + num2
    }else if(typeof num1 === "string" && typeof num2 === "string" ){
